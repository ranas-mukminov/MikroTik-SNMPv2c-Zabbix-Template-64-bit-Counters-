...
def build_snapshot() -> InventorySnapshot:
    node = Node(name="n1", kind="proxmox", cpu_cores=8, memory_gb=32, power_profile=PowerProfile(base_idle_watts=80))
    workload = Workload(name="vm", workload_type="vm", cpu_cores=2, memory_gb=4, utilization=0.5, node_name="n1")
